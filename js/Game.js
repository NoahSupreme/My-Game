class Game {
  ...
  handleElements() {
    ...
    this.leadeboardTitle.position(width / 5.5 , 130);

    this.leader1.class("leadersText");
    this.leader1.position(width / 5.5, 160);

    this.leader2.class("leadersText");
    this.leader2.position(width / 5.5 , 180);
  }
 ...
 finalDecision() {
  if (gameState === 2 && player.positionY > height * 6 - 100){
